...
import { Shield, User, Mail, Lock, AlertTriangle, ArrowRight, RefreshCw } from 'lucide-react';
...
export const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // AuthContext state update automatically triggers dashboard navigation
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-dark-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-emerald-950/15 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-15%] left-[-10%] w-[500px] h-[500px] bg-teal-950/15 rounded-full blur-[120px] pointer-events-none animate-pulse-glow" style={{ animationDelay: '2.5s' }} />
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-400 text-sm">
            Sign up below to access your secure dashboard
          </p>
        </div>
